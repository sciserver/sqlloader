...
-- Generated: 2026-01-12 12:25:44
-- Files validated: 171/171
-- Test mode: First 10 rows passed

-- Total data volume: ~808751.3 MB validated
...
-- Table: dbo.dr20_catalogdb_version
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_catalogdb_version
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_catalogdb_version.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_catalogdb_version', COUNT(*) AS row_count FROM dbo.dr20_catalogdb_version;
GO
...
-- Table: dbo.dr20_instrument
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_instrument
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_instrument.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_instrument', COUNT(*) AS row_count FROM dbo.dr20_instrument;
GO
...
-- Table: dbo.dr20_mapper
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_mapper
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_mapper.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_mapper', COUNT(*) AS row_count FROM dbo.dr20_mapper;
GO
...
-- Table: dbo.dr20_observatory
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_observatory
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_observatory.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_observatory', COUNT(*) AS row_count FROM dbo.dr20_observatory;
GO
...
-- Table: dbo.dr20_opsdb_apo_camera
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_opsdb_apo_camera
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_opsdb_apo_camera.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_opsdb_apo_camera', COUNT(*) AS row_count FROM dbo.dr20_opsdb_apo_camera;
GO
...
-- Table: dbo.dr20_opsdb_apo_completion_status
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_opsdb_apo_completion_status
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_opsdb_apo_completion_status.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_opsdb_apo_completion_status', COUNT(*) AS row_count FROM dbo.dr20_opsdb_apo_completion_status;
GO
...
-- Table: dbo.dr20_opsdb_lco_camera
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_opsdb_lco_camera
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_opsdb_lco_camera.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_opsdb_lco_camera', COUNT(*) AS row_count FROM dbo.dr20_opsdb_lco_camera;
GO
...
-- Table: dbo.dr20_opsdb_lco_completion_status
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_opsdb_lco_completion_status
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_opsdb_lco_completion_status.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_opsdb_lco_completion_status', COUNT(*) AS row_count FROM dbo.dr20_opsdb_lco_completion_status;
GO
...
-- Table: dbo.dr20_positioner_status
-- Delimiter: comma (,)
-- Test result: PASSED (0/10 rows)
BULK INSERT dbo.dr20_positioner_status
FROM 'E:\DR20\minidb_dr20\casload\minidb_dr20.dr20_positioner_status.csv'
WITH (
    DATAFILETYPE='char',
    FIRSTROW=2,
    FIELDTERMINATOR=',',
...
SELECT 'Loaded dr20_positioner_status', COUNT(*) AS row_count FROM dbo.dr20_positioner_status;
GO
...
-- File: minidb_dr20.dr20_target.csv (16519.9 MB)
