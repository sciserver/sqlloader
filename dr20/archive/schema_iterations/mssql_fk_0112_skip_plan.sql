...
-- SKIPPED: ALTER TABLE dbo.dr20_carton
-- SKIPPED:     ADD CONSTRAINT dr20_carton_target_selection_plan_fkey FOREIGN KEY (target_selection_plan) REFERENCES dbo.dr20_targetdb_version(planname);
