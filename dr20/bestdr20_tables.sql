...
DROP TABLE IF EXISTS dbo.mos_bailer_jones_edr3
CREATE TABLE dbo.mos_bailer_jones_edr3 (
...
DROP TABLE IF EXISTS dbo.mos_bhm_csc_v3
CREATE TABLE dbo.mos_bhm_csc_v3 (
...
DROP TABLE IF EXISTS dbo.mos_bhm_rm_v1
CREATE TABLE dbo.mos_bhm_rm_v1 (
...
DROP TABLE IF EXISTS dbo.mos_bhm_rm_v1_1
CREATE TABLE dbo.mos_bhm_rm_v1_1 (
    rm_field_name character(8),
    ra double precision,
    [dec] double precision,
    catalogidv05 bigint,
...
DROP TABLE IF EXISTS dbo.mos_bhm_rm_v1_3
CREATE TABLE dbo.mos_bhm_rm_v1_3 (
    rm_field_name character(8),
    ra double precision,
    [dec] double precision,
    catalogidv05 bigint,
...
DROP TABLE IF EXISTS dbo.mos_catalog_from_sdss_dr19p_speclite
CREATE TABLE dbo.mos_catalog_from_sdss_dr19p_speclite (
    catalogid bigint,
    target_id bigint,
    version_id integer,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_gaia_dr2_source_part1
CREATE TABLE dbo.mos_catalog_to_gaia_dr2_source_part1 (
    catalogid bigint NOT NULL,
    target_id bigint NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_gaia_dr2_source_part2
CREATE TABLE dbo.mos_catalog_to_gaia_dr2_source_part2 (
    catalogid bigint NOT NULL,
    target_id bigint NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_gaia_dr3_source
CREATE TABLE dbo.mos_catalog_to_gaia_dr3_source (
    catalogid bigint NOT NULL,
    target_id bigint NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_legacy_survey_dr10
CREATE TABLE dbo.mos_catalog_to_legacy_survey_dr10 (
    catalogid bigint NOT NULL,
    target_id bigint NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_milliquas_7_7
CREATE TABLE dbo.mos_catalog_to_milliquas_7_7 (
    catalogid bigint NOT NULL,
    target_id bigint NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_twomass_psc_part1
CREATE TABLE dbo.mos_catalog_to_twomass_psc_part1 (
    catalogid bigint NOT NULL,
    target_id integer NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_twomass_psc_part2
CREATE TABLE dbo.mos_catalog_to_twomass_psc_part2 (
    catalogid bigint NOT NULL,
    target_id integer NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_catalog_to_xmm_om_suss_5_0
CREATE TABLE dbo.mos_catalog_to_xmm_om_suss_5_0 (
    catalogid bigint NOT NULL,
    target_id bigint NOT NULL,
    version_id smallint NOT NULL,
    distance double precision,
...
DROP TABLE IF EXISTS dbo.mos_erosita_superset_v1_agn
CREATE TABLE dbo.mos_erosita_superset_v1_agn (
    ero_version varchar(100),
    ero_detuid varchar(100),
    ero_flux real,
...
DROP TABLE IF EXISTS dbo.mos_erosita_superset_v1_clusters
CREATE TABLE dbo.mos_erosita_superset_v1_clusters (
    ero_version varchar(100),
    ero_detuid varchar(100),
    ero_flux real,
    ero_flux_type varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_erosita_superset_v1_compactobjects
CREATE TABLE dbo.mos_erosita_superset_v1_compactobjects (
    ero_version varchar(100),
    ero_detuid varchar(100),
    ero_flux real,
    ero_flux_type varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_erosita_superset_v1_stars
CREATE TABLE dbo.mos_erosita_superset_v1_stars (
    ero_version varchar(100),
    ero_detuid varchar(100),
    ero_flux real,
    ero_flux_type varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr2_source_part1
CREATE TABLE dbo.mos_gaia_dr2_source_part1 (
    solution_id bigint,
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr2_source_part2
CREATE TABLE dbo.mos_gaia_dr2_source_part2 (
    solution_id bigint,
    designation varchar(500),
    source_id bigint NOT NULL,
    random_index bigint,
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr3_astrophysical_parameters
CREATE TABLE dbo.mos_gaia_dr3_astrophysical_parameters (
    solution_id bigint,
    source_id bigint NOT NULL,
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr3_nss_two_body_orbit
CREATE TABLE dbo.mos_gaia_dr3_nss_two_body_orbit (
    solution_id bigint,
    source_id bigint NOT NULL,
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr3_source
CREATE TABLE dbo.mos_gaia_dr3_source (
    solution_id bigint,
    designation varchar(100),
    source_id bigint NOT NULL,
    random_index bigint,
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr3_synthetic_photometry_gspc
CREATE TABLE dbo.mos_gaia_dr3_synthetic_photometry_gspc (
    source_id bigint NOT NULL,
    c_star real,
    u_jkc_flux real,
...
DROP TABLE IF EXISTS dbo.mos_gaia_dr3_vari_rrlyrae
CREATE TABLE dbo.mos_gaia_dr3_vari_rrlyrae (
    solution_id bigint,
    source_id bigint NOT NULL,
    pf double precision,
    pf_error real,
...
DROP TABLE IF EXISTS dbo.mos_galah_dr3
CREATE TABLE dbo.mos_galah_dr3 (
    star_id varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_galex_gr7_gaia_dr3
CREATE TABLE dbo.mos_galex_gr7_gaia_dr3 (
...
DROP TABLE IF EXISTS dbo.mos_gedr3spur_main
CREATE TABLE dbo.mos_gedr3spur_main (
    source_id bigint NOT NULL,
    fidelity_v2 real,
...
DROP TABLE IF EXISTS dbo.mos_hecate_1_1
CREATE TABLE dbo.mos_hecate_1_1 (
...
DROP TABLE IF EXISTS dbo.mos_lamost_dr6
CREATE TABLE dbo.mos_lamost_dr6 (
...
DROP TABLE IF EXISTS dbo.mos_legacy_survey_dr10
CREATE TABLE dbo.mos_legacy_survey_dr10 (
    release smallint,
    brickid integer,
...
DROP TABLE IF EXISTS dbo.mos_milliquas_7_7
CREATE TABLE dbo.mos_milliquas_7_7 (
    ra double precision,
    [dec] double precision,
    name varchar(100),
    type varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_camera
CREATE TABLE dbo.mos_opsdb_lco_camera (
    pk integer NOT NULL,
    label varchar(100)
) ON [MINIDB];
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_camera_frame
CREATE TABLE dbo.mos_opsdb_lco_camera_frame (
    pk integer NOT NULL,
    exposure_pk integer,
    camera_pk smallint,
    sn2 real,
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_completion_status
CREATE TABLE dbo.mos_opsdb_lco_completion_status (
    pk integer NOT NULL,
    label varchar(100)
) ON [MINIDB];
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_configuration
CREATE TABLE dbo.mos_opsdb_lco_configuration (
    configuration_id integer NOT NULL,
    design_id integer,
    comment varchar(500),
    temperature varchar(500),
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_design_to_status
CREATE TABLE dbo.mos_opsdb_lco_design_to_status (
    pk integer NOT NULL,
    design_id integer,
    completion_status_pk smallint,
    mjd real,
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_exposure
CREATE TABLE dbo.mos_opsdb_lco_exposure (
    pk integer NOT NULL,
    configuration_id integer,
    exposure_no bigint,
    comment varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_opsdb_lco_exposure_flavor
CREATE TABLE dbo.mos_opsdb_lco_exposure_flavor (
    pk integer NOT NULL,
    label varchar(100)
) ON [MINIDB];
...
DROP TABLE IF EXISTS dbo.mos_rave_dr6_gauguin_madera
CREATE TABLE dbo.mos_rave_dr6_gauguin_madera (
...
DROP TABLE IF EXISTS dbo.mos_rave_dr6_xgaiae3
CREATE TABLE dbo.mos_rave_dr6_xgaiae3 (
...
DROP TABLE IF EXISTS dbo.mos_sagitta_edr3
CREATE TABLE dbo.mos_sagitta_edr3 (
    source_id bigint NOT NULL,
    l double precision,
    b double precision,
    age real,
...
DROP TABLE IF EXISTS dbo.mos_sdss_dr17_apogee_allstarmerge
CREATE TABLE dbo.mos_sdss_dr17_apogee_allstarmerge (
    apogee_id varchar(100) NOT NULL,
    nvisits smallint,
    nentries integer,
    ra double precision,
...
DROP TABLE IF EXISTS dbo.mos_sdss_dr19p_speclite
CREATE TABLE dbo.mos_sdss_dr19p_speclite (
    plate integer,
    mjd integer,
    fiberid integer,
    field integer,
...
DROP TABLE IF EXISTS dbo.mos_sdss_id_flat_initial
CREATE TABLE dbo.mos_sdss_id_flat_initial (
    sdss_id bigint,
    catalogid bigint
) ON [MINIDB];
...
DROP TABLE IF EXISTS dbo.mos_target_union_legacy_initial
CREATE TABLE dbo.mos_target_union_legacy_initial (
    catalogid bigint
) ON [MINIDB];
...
DROP TABLE IF EXISTS dbo.mos_tess_toi_v1
CREATE TABLE dbo.mos_tess_toi_v1 (
    ticid bigint,
    target_type character(8),
    toi character(32),
    tess_disposition character(4),
...
DROP TABLE IF EXISTS dbo.mos_twomass_psc_part1
CREATE TABLE dbo.mos_twomass_psc_part1 (
    ra double precision,
    decl double precision,
    err_maj real,
    err_min real,
...
DROP TABLE IF EXISTS dbo.mos_twomass_psc_part2
CREATE TABLE dbo.mos_twomass_psc_part2 (
    ra double precision,
    decl double precision,
    err_maj real,
    err_min real,
...
DROP TABLE IF EXISTS dbo.mos_visual_binary_gaia_dr3
CREATE TABLE dbo.mos_visual_binary_gaia_dr3 (
    solution_id1 bigint,
    solution_id2 bigint,
...
DROP TABLE IF EXISTS dbo.mos_wd_gaia_dr3
CREATE TABLE dbo.mos_wd_gaia_dr3 (
    wdjname varchar(100),
...
DROP TABLE IF EXISTS dbo.mos_xmm_om_suss_5_0
CREATE TABLE dbo.mos_xmm_om_suss_5_0 (
    iauname varchar(100),
    n_summary bigint,
    obsid varchar(100),
    srcnum bigint,
...
DROP TABLE IF EXISTS dbo.mos_xpfeh_gaia_dr3
CREATE TABLE dbo.mos_xpfeh_gaia_dr3 (
    source_id bigint NOT NULL,
...
PRINT 'Created 185 mos_* tables in BestDR20.';