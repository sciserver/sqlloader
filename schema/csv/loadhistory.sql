...
INSERT History VALUES('MetadataTables','2019-12-05','Sue','changed varchar to sysname in Diagnostics / SiteDiagnostics ');
...
INSERT History VALUES('IndexMap','2025-04-18','Ani','Added Astra and APOGEE DRP files (DR19). ');
INSERT History VALUES('IndexMap','2025-04-23','Ani','Added DR19 VAC PKs (DR19). ');
INSERT History VALUES('IndexMap','2025-05-20','Ani','Added allspec PKs (DR19). ');
INSERT History VALUES('IndexMap','2025-06-11','Ani','Added apogee_drp_all[star|visit] PKs. (DR19) ');
INSERT History VALUES('IndexMap','2025-06-12','Ani','Commented out StarFlow_summary PK creation (identity column PK to be added as for all Astra tables. (DR19) ');
...
INSERT History VALUES('SpectroTables','2024-09-03','Ani','Swapped in spAll* tables. (DR19)  ');
...
INSERT History VALUES('ApogeeTables','2016-03-16','Ani','DR13 updates. ');
INSERT History VALUES('ApogeeTables','2016-03-30','Ani','More DR13 updates - ce_* and felem_ce* columns removed.. ');
INSERT History VALUES('ApogeeTables','2016-05-13','Ani','Updated felem* column descriptions in aspcapStar as per Jen Sobeck. ');
INSERT History VALUES('ApogeeTables','2017-04-11','Ani','Added the DR14 schema updates, including new table cannonStar. ');
INSERT History VALUES('ApogeeTables','2017-04-19','Ani','Updated cannonStar schema from SVN, added default values for cannonStar.filename and field columns because the CSVs have NULL values. ');
INSERT History VALUES('ApogeeTables','2017-05-06','Ani','Added columns to apogeeVisit and apogeeStar for DR14. ');
INSERT History VALUES('ApogeeTables','2018-07-18','Ani','Removed conditional DROP TABLE from tables that do not get recreated with each release (apogeeDesign/Field/Object). ');
INSERT History VALUES('ApogeeTables','2019-11-14','Ani','DR16 schema changes. 2021-06-23 DR17 schema changes. ');
INSERT History VALUES('ApogeeTables','2021-06-23','Ani','Fixed bug in ApogeeStar, put "file" column name in []. Also commented out cannonStar which is not reloaded in DR17. ');
...
INSERT History VALUES('spValidate','2024-08-22','Ani','Added spValidateEboss. (DR19) ');
INSERT History VALUES('spValidate','2025-04-16','Ani','Added spValidateAstra. (DR19) ');
INSERT History VALUES('spValidate','2025-04-21','Ani','Added spValidateDR19VACs. (DR19) ');
INSERT History VALUES('spValidate','2025-05-16','Ani','Added spValidateAllspec. (DR19) ');
INSERT History VALUES('spValidate','2025-05-26','Ani','Added StarFlow, StarHorse and eROSITA VACs to  spValidateDR19VACs. (DR19) ');
INSERT History VALUES('spValidate','2025-06-11','Ani','Added apogee_drp_all[star|visit] to spValidateApogee. (DR19) ');
INSERT History VALUES('spValidate','2025-06-12','Ani','Replaced StarFlow_summary PK with identity column. (DR19) ');
...
INSERT History VALUES('spPublish','2024-09-06','Ani','Re-added eBOSS. (DR19) ');
INSERT History VALUES('spPublish','2025-04-16','Ani','Added Astra. (DR19) ');
INSERT History VALUES('spPublish','2025-04-25','Ani','Added DR19 VACs. (DR19) ');
INSERT History VALUES('spPublish','2025-05-16','Ani','Added Allspec. (DR19) ');
INSERT History VALUES('spPublish','2025-05-26','Ani','StarFlow, StarHorse and eROSITA VACs to  spPublishDR19VACs. (DR19) ');
INSERT History VALUES('spPublish','2025-06-11','Ani','Added apogee_drp_all[star|visit] to spPublishApogee. (DR19) ');
