-- Patch to update SpecPhotoAll schema for DR9 and reload it.
USE BestDR9
GO

EXEC spIndexDropSelection 1, 1349, 'F', 'SpecPhotoAll'
EXEC spIndexDropSelection 1, 1349, 'I', 'SpecPhotoAll'
EXEC spIndexDropSelection 1, 1349, 'K', 'SpecPhotoAll'

-- Update the SpecPhotoAll schema (new columns added for DR9).
--=============================================================
...
-- Enable cmd shell to run scripts.
...
-- Run the spFinish.sql script to update spBuildSpecPhotoAll.
EXEC spRunSQLScript 1, 1349, 'Sync Schema', 'C:\sqlLoader\schema\sql', 'spFinish.sql','BestDR9','C:\temp\BestDR9schemaSync.txt' 

-- Run the spSynchronize procedure to update PhotoObjAll.specobjid and SpecPhotoAll
EXEC spSynchronize 1, 1349

EXEC spIndexBuildSelection 1, 1349, 'K', 'SpecPhotoAll'
EXEC spIndexBuildSelection 1, 1349, 'I', 'SpecPhotoAll'
EXEC spIndexBuildSelection 1, 1349, 'F', 'SpecPhotoAll'

-- Update the metadata tables.
EXEC spLoadMetaData 1, 1349, 'C:\sqlLoader\schema\csv\', 1
