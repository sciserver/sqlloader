...
--	fHtmEq			-- convert HTMID to ra,dec
--	fHtmXyz			-- convert HTMID to XYZ
--	fHtmGetString		-- get string name for HTMID
--      fHtmGetCenterPoint	-- get center points
--      fHtmGetCornerPoints	-- get corner points
---- HTM covers of various shapes ----------------
--	fHtmCoverCircleEq	-- get cover for circle ra,dec,r
--	fHtmCoverCircleXyz	-- get cover for circle x,y,z,r
--	fHtmCoverRegion		-- get cover for generic region
--	fHtmCoverRegionError	-- get error message for region spec	
--	fHtmCoverRegionAdvanced	-- get inner/outer cover
--	fHtmCoverBinaryAdvanced -- get inner/outer cover from bin region
--	fHtmCoverRegionList	-- get trixel list with inner/outer flag
------------------------------------
...
--* 2008-06-25 Ani:  Fixed fHtmCoverRegion description so that the syntax is
--*                  displayed with newlines rather than as one very long line.
--* 2008-09-29 Ani:  Incorporated comment changes from latest HTM rebuild.
--* 2011-06-06 Ani:  Incorporated changes from latest version from Tamas.
------------------------------------------------------------------------
SET NOCOUNT ON
GO
...
--/T <pre>
--/T circleSpec  =>     CIRCLE J2000 ra dec  radArcMin  <br>
--/T            |       CIRCLE CARTESIAN x y z   radArcMin <br>
--/T rectSpec    =>     RECT J2000      {ra dec }2 <br>
--/T            |       RECT CARTESIAN  {x y z  }2 <br>
--/T polySpec    =>     POLY J2000      {ra dec }3+ <br>
--/T            |       POLY CARTESIAN  {x y z  }3+ <br>
--/T hullSpec    =>     CHULL J2000     {ra dec }3+ <br>
--/T            |       CHULL CARTESIAN {x y z  }3+ <br>
--/T convexSpec	 =>     CONVEX { x y z D}* <br>
--/T coverSpec	 =>     circleSpec | rectSpec | polySpec | hullSpec | convexSpec <br>
--/T regionSpec	 =>     REGION {coverSpec}* | coverspec <br>
--/T for the circle the REGION prefix is optional.
--/T </pre> 
