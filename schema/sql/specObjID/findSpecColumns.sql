...
select ctei.TableName, ctei.IndexName
--into tempdb.dbo.specPKs
--select 'ALTER TABLE ' + ctei.TableName + ' ALTER COLUMN [SpecObjID] NUMERIC(20) NOT NULL'
from cteIndexes ctei
where ctei.IndexType = 1
and ctei.TableName not like '%DR7%'
 and ctei.colType = 127