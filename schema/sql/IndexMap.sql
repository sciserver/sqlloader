...
-----------------------------------------------------
INSERT IndexMap Values('K','primary key', 'PartitionMap',	'fileGroupName'		,'','META');
INSERT IndexMap Values('K','primary key', 'FileGroupMap',	'tableName'		,'','META');
INSERT IndexMap Values('K','primary key', 'IndexMap',	 	'indexmapid'		,'','META');
INSERT IndexMap Values('K','primary key', 'PubHistory', 	'name,loadversion'	,'','META');
INSERT IndexMap Values('K','primary key', 'QueryResults', 	'query, time'		,'','META');
INSERT IndexMap Values('K','primary key', 'RecentQueries', 	'ipAddr,lastQueryTime'	,'','META');
INSERT IndexMap Values('K','primary key', 'RunShift', 	 	'run'			,'','META');
INSERT IndexMap Values('K','primary key', 'Versions', 	 	'version'		,'','META');
INSERT IndexMap Values('K','primary key', 'DBObjects', 	 	'name'			,'','META');
INSERT IndexMap Values('K','primary key', 'DBColumns', 	 	'tableName,name'	,'','META');
INSERT IndexMap Values('K','primary key', 'DBViewCols', 	'viewName,name'		,'','META');
INSERT IndexMap Values('K','primary key', 'History', 	 	'id'			,'','META');
INSERT IndexMap Values('K','primary key', 'Inventory', 	 	'filename,name'		,'','META');
INSERT IndexMap Values('K','primary key', 'Dependency', 	'parent,child'		,'','META');
INSERT IndexMap Values('K','primary key', 'DataConstants',   	'field,name'		,'','META');
INSERT IndexMap Values('K','primary key', 'Diagnostics', 	'name'			,'','META');
INSERT IndexMap Values('K','primary key', 'SDSSConstants',   	'name'			,'','META');
INSERT IndexMap Values('K','primary key', 'SiteConstants',   	'name'			,'','META');
INSERT IndexMap Values('K','primary key', 'SiteDiagnostics', 	'name'			,'','META');
INSERT IndexMap Values('K','primary key', 'ProfileDefs', 	'bin'			,'','META');
INSERT IndexMap Values('K','primary key', 'LoadHistory', 	'loadVersion,tStart'	,'','META');
-----------------------------------------------------
-- Primary Keys for the PHOTO tables
-----------------------------------------------------
INSERT IndexMap Values('K','primary key', 'PhotoObjAll',	'objID'			,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'PhotoProfile',  	'objID,bin,band'	,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'AtlasOutline',	 	'objID'			,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'Frame',		'fieldID,zoom'		,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'PhotoPrimaryDR7',	'dr8objID'			,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'PhotoObjDR7',	'dr8objID'			,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'Photoz', 	 	'objID'	,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'PhotozErrorMap',     'cellID' ,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'Field',		'fieldID'		,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'FieldProfile',  	'fieldID,bin,band'	,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'Mask', 		'maskID'		,'','PHOTO');
...
INSERT IndexMap Values('K','primary key', 'StripeDefs', 	'stripe'		,'','PHOTO');
INSERT IndexMap Values('K','primary key', 'MaskedObject', 	'objid,maskid'		,'','PHOTO');
...
-----------------------------------------------------
INSERT IndexMap Values('K','primary key', 'PlateX', 	 	'plateID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'SpecObjAll', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'SpecDR7', 		'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'sppParams', 	 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'sppLines', 	 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'segueTargetAll', 	 'objID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'galSpecExtra', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'galSpecIndx', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'galSpecInfo', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'galSpecLine', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'emissionLinesPort', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'stellarMassFSPSGranEarlyDust', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'stellarMassFSPSGranEarlyNoDust', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'stellarMassFSPSGranWideDust', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'stellarMassFSPSGranWideNoDust', 	'specObjID'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'stellarMassPCAWiscBC03', 	'specObjID'		,'','SPECTRO');
...
INSERT IndexMap Values('K','primary key', 'apogeePlate', 	 	'plate_visit_id'	,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'aspcapStarCovar', 	 	'aspcap_covar_id,aspcap_id'		,'','SPECTRO');
...
INSERT IndexMap Values('K','primary key', 'zoo2Stripe82Coadd1', 	'stripe82objid'		,'','SPECTRO');
INSERT IndexMap Values('K','primary key', 'zoo2Stripe82Coadd2', 	'stripe82objid'		,'','SPECTRO');
...
-----------------------------------------------------
INSERT IndexMap Values('K','primary key', 'Target', 	 	'targetID'		,'','TILES');
INSERT IndexMap Values('K','primary key', 'TargetInfo',	 	'skyVersion,targetID'	,'','TILES');
INSERT IndexMap Values('K','primary key', 'sdssTargetParam', 	'targetVersion,paramFile,name'	,'','TILES');
--
INSERT IndexMap Values('K','primary key', 'sdssTileAll', 		'tile'			,'','TILES');
INSERT IndexMap Values('K','primary key', 'sdssTilingGeometry', 	 'tilingGeometryID'	,'','TILES');
...
-----------------------------------------------------
INSERT IndexMap Values('K','primary key', 'RMatrix', 	 	'mode,row'		,'','REGION');
INSERT IndexMap Values('K','primary key', 'Region', 	 	'regionId'		,'','REGION');
--	INSERT IndexMap Values('K','primary key', 'RegionConvex', 'regionid,convexid,patch'	,'','REGION');
INSERT IndexMap Values('K','primary key', 'HalfSpace',   	'constraintid'		,'','REGION');
INSERT IndexMap Values('K','primary key', 'RegionArcs',	  'regionId,convexid,arcid'	,'','REGION');
INSERT IndexMap Values('K','primary key', 'RegionPatch',  'regionid,convexid,patchid'	,'','REGION');
INSERT IndexMap Values('K','primary key', 'sdssImagingHalfspaces', 		'sdssPolygonID,x,y,z'			,'','REGION');
INSERT IndexMap Values('K','primary key', 'sdssPolygon2Field', 		'sdssPolygonID,fieldID'			,'','REGION');
INSERT IndexMap Values('K','primary key', 'sdssPolygons', 		'sdssPolygonID'			,'','REGION');
-----------------------------------------------------
-- Primary Keys for the FINISH tables
-----------------------------------------------------
INSERT IndexMap Values('K','primary key', 'Zone', 		'zoneID,ra,objID'	,'','ZONE');
INSERT IndexMap Values('K','primary key', 'Neighbors', 	 	'objID,NeighborObjID'	,'','NEIGHBORS');
INSERT IndexMap Values('K','primary key', 'SpecPhotoAll',	'specObjID'		,'','FINISH');

--------------------------------------------------
-- Foreign keys for PHOTO
--------------------------------------------------
INSERT IndexMap Values('F','foreign key', 'PhotoObjAll', 	'fieldID'	,'Field(fieldID)'	,'PHOTO');
INSERT IndexMap Values('F','foreign key', 'PhotoProfile',  	'objID'		,'PhotoObjAll(objID)'	,'PHOTO');
INSERT IndexMap Values('F','foreign key', 'AtlasOutline', 	 	'objID'		,'PhotoObjAll(objID)'	,'PHOTO');
INSERT IndexMap Values('F','foreign key', 'Frame', 		'fieldID'	,'Field(fieldID)'	,'PHOTO');
...
--
INSERT IndexMap Values('F','foreign key', 'FieldProfile',  	'fieldID'	,'Field(fieldID)'	,'PHOTO');
INSERT IndexMap Values('F','foreign key', 'ProperMotions', 	'objID'		,'PhotoObjAll(objID)'	,'PHOTO');
INSERT IndexMap Values('F','foreign key', 'MaskedObject', 	'objID'		,'PhotoObjAll(objID)'	,'PHOTO');
INSERT IndexMap Values('F','foreign key', 'MaskedObject', 	'maskID'	,'Mask(maskID)'		,'PHOTO');
--------------------------------------------------
...
INSERT IndexMap Values('F','foreign key', 'zoo2Stripe82Normal', 'dr8objid'	,'PhotoObjAll(objid)','SPECTRO');
--------------------------------------------------
-- Foreign keys for TILES
--------------------------------------------------
INSERT IndexMap Values('F','foreign key', 'TargetInfo', 	'targetID'	,'Target(targetID)'	,'TILES');
INSERT IndexMap Values('F','foreign key', 'sdssTileAll', 	 	'tileRun'	,'sdssTilingRun(tileRun)'	,'TILES');
INSERT IndexMap Values('F','foreign key', 'sdssTilingGeometry',	'tileRun'	,'sdssTilingRun(tileRun)'	,'TILES');
-- INSERT IndexMap Values('F','foreign key', 'sdssTilingGeometry',	'stripe'	,'StripeDefs(stripe)'	,'TILES');
--	INSERT IndexMap Values('F','foreign key', 'sdssTiledTargetAll',	'tile'		,'sdssTileAll(tile)'	,'TILES');
INSERT IndexMap Values('F','foreign key', 'sdssTilingInfo',	 	'tileRun'	,'sdssTilingRun(tileRun)'	,'TILES');
--------------------------------------------------
-- Foreign keys for REGION
--------------------------------------------------
--	INSERT IndexMap Values('F','foreign key', 'RegionConvex', 	'regionID'	,'Region(regionID)'	,'REGION');
INSERT IndexMap Values('F','foreign key', 'HalfSpace', 		'regionID'	,'Region(regionID)'	,'REGION');
INSERT IndexMap Values('F','foreign key', 'RegionArcs', 	'regionID'	,'Region(regionID)'	,'REGION');
INSERT IndexMap Values('F','foreign key', 'RegionPatch', 	'regionID'	,'Region(regionID)'	,'REGION');
--------------------------------------------------
-- Foreign keys for FINISH
--------------------------------------------------
INSERT IndexMap Values('F','foreign key', 'Zone',  		'objID'		,'PhotoObjAll(objID)'	,'ZONE');
INSERT IndexMap Values('F','foreign key', 'Neighbors',  	'objID'		,'PhotoObjAll(objID)'	,'NEIGHBORS');
INSERT IndexMap Values('F','foreign key', 'SpecPhotoAll',	'specObjID'	,'SpecObjAll(specObjID)','FINISH');
-- 
--
--------------------------------------------------
-- Foreign keys for META
--------------------------------------------------
INSERT IndexMap Values('F','foreign key', 'DBColumns', 		'tablename'	,'DBObjects(name)'	,'META');
INSERT IndexMap Values('F','foreign key', 'DBViewCols', 	'viewname'	,'DBObjects(name)'	,'META');
INSERT IndexMap Values('F','foreign key', 'IndexMap', 		'tableName'	,'DBObjects(name)'	,'META');
INSERT IndexMap Values('F','foreign key', 'FileGroupMap', 	'tableFileGroup','PartitionMap(fileGroupName)'	,'META');
INSERT IndexMap Values('F','foreign key', 'Inventory', 		'name'		,'DBObjects(name)'	,'META');
-- 
--
--------------------------------------------------
...
-- Indexes for PHOTO
--------------------------------------------------
INSERT IndexMap Values('I','index', 'Field', 	 	'field,camcol,run,rerun'			,'','PHOTO');
INSERT IndexMap Values('I','index', 'Field', 	 	'run,camcol,field,rerun'			,'','PHOTO');
INSERT IndexMap Values('I','index', 'Frame', 	 	'field,camcol,run,zoom,rerun'			,'','PHOTO');
INSERT IndexMap Values('I','index', 'Frame', 	 	'htmID,zoom,cx,cy,cz,a,b,c,d,e,f,node,incl'	,'','PHOTO');
INSERT IndexMap Values('I','index', 'Mask', 	 	'htmID,ra,dec,cx,cy,cz'				,'','PHOTO');
--
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'mode,cy,cx,cz,htmID,type,flags,ra,dec,u,g,r,i,z'		,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'htmID,cx,cy,cz,type,mode,flags,ra,dec,u,g,r,i,z'		,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'htmID,run,camcol,field,rerun,type,mode,flags,cx,cy,cz,g,r' ,'','PHOTO'); 
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'field,run,rerun,camcol,type,mode,flags,rowc,colc,ra,dec,u,g,r,i,z'	,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'fieldID,objID,ra,dec,r,type,flags'	 			,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'SpecObjID,cx,cy,cz,mode,type,flags,ra,dec,u,g,r,i,z'	,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'cx,cy,cz,htmID,mode,type,flags,ra,dec,u,g,r,i,z'	 	,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'run,mode,type,flags,u,g,r,i,z,Err_u,Err_g,Err_r,Err_i,Err_z'	,'','PHOTO');
INSERT IndexMap Values('I','index', 'PhotoObjAll', 	 'run,camcol,rerun,type,mode,flags,ra,dec,fieldID,field,u,g,r,i,z','','PHOTO');
...
INSERT IndexMap Values('I','index', 'TwoMass', 		 'ra'						,'','PHOTO');
INSERT IndexMap Values('I','index', 'TwoMass', 		 'dec'						,'','PHOTO');
INSERT IndexMap Values('I','index', 'TwoMass', 		 'j'						,'','PHOTO');
INSERT IndexMap Values('I','index', 'TwoMass', 		 'h'						,'','PHOTO');
INSERT IndexMap Values('I','index', 'TwoMass', 		 'k'						,'','PHOTO');
INSERT IndexMap Values('I','index', 'TwoMass', 		 'ccflag'					,'','PHOTO');
INSERT IndexMap Values('I','index', 'TwoMass', 		 'phqual'					,'','PHOTO');
...
INSERT IndexMap Values('I','index', 'WISE_allsky',	 'glat,glon'			,'','PHOTO');
...
-- Indexes on SPECTRO
-------------------------------
INSERT IndexMap Values('I','index', 		'PlateX', 	 'htmID,ra,dec,cx,cy,cz'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'SpecObjAll', 	 'htmID,ra,dec,cx,cy,cz,sciencePrimary'	,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'SpecObjAll', 	 'BestObjID,sourceType,sciencePrimary,class,htmID,ra,dec,plate,mjd,fiberid,z,zErr'	,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'SpecObjAll', 	 'class,zWarning,z,sciencePrimary,plateId,bestObjID,targetObjId,htmID,ra,dec'	 		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'SpecObjAll', 	 'targetObjID,sourceType,sciencePrimary,class,htmID,ra,dec', '','SPECTRO');
INSERT IndexMap Values('I','index',             'SpecObjAll',    'ra,[dec],class, plate, tile, z, zErr, sciencePrimary,plateID, bestObjID','','SPECTRO'); 
INSERT IndexMap Values('I','index',             'SpecObjAll',    'fluxObjID','','SPECTRO'); 
INSERT IndexMap Values('I','index',             'segueTargetAll',    'segue1_target1, segue2_target1','','SPECTRO'); 
INSERT IndexMap Values('I','index', 		'apogeeObject',		'apogee_id,j,h,k,j_err,h_err,k_err'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'apogeeVisit',		'apogee_id'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'apogeeVisit',		'plate,mjd,fiberid'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'apogeeStar',		'apogee_id'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'apogeeStar',		'htmID'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'aspcapStar',		'apstar_id'		,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'zooSpec', 	 	'objID'			,'','SPECTRO');
INSERT IndexMap Values('I','index', 		'zooConfidence', 	'objID'			,'','SPECTRO');
--
-------------------------------
-- Indexes on TILES
-----------------------------------------------------
...
*/
INSERT IndexMap Values('I','unique index', 	'sdssTileAll', 	 'tileRun,tile'					,'','TILES');
INSERT IndexMap Values('I','index', 		'sdssTileAll', 	 'htmID,racen,deccen,cx,cy,cz'			,'','TILES');
--	INSERT IndexMap Values('I','unique index', 	'sdssTiledTargetAll','targetId'				,'','TILES');
INSERT IndexMap Values('I','index', 		'sdssTiledTargetAll','htmID,ra,dec,cx,cy,cz'		,'','TILES');
--	INSERT IndexMap Values('I','unique index', 	'sdssTiledTargetAll','sourceType,targetId'			,'','TILES');
INSERT IndexMap Values('I','unique index', 	'sdssTilingInfo',	 'targetID,tileRun,collisionGroup'		,'','TILES');
INSERT IndexMap Values('I','unique index', 	'sdssTilingInfo',	 'tileRun,tid,collisionGroup'		,'','TILES');
INSERT IndexMap Values('I','index', 		'sdssTilingInfo',	 'tile,collisionGroup'			,'','TILES');
-----------------------------------------------------
-- Indexes on REGION
-----------------------------------------------------
INSERT IndexMap Values('I','index', 		'HalfSpace',	 'regionID,convexID,x,y,z,c'			,'','REGION');
INSERT IndexMap Values('I','index', 	  	'RegionPatch',   'htmID,ra,dec,x,y,z,type'	,'','REGION');
-----------------------------------------------------
-- Indexes on FINISH
-----------------------------------------------------
...
-- Index on META
-----------------------------------------------------
INSERT IndexMap Values('I','index', 		'DataConstants', 'value'		,'','META');
-----------------------------------------------------
GO
--
