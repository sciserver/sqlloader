...
--* 2026-06-11  Ani: Swapped in updated version of allspec. (DR20)
--* 2026-06-17  Ani: Swapped in updated version of spall* tables. (DR20)
------------------------------------------------------------------------
...
--===============================================================
-- spAll table added for DR18 and updated in subsequent releases.
--===============================================================
if exists (select * from dbo.sysobjects 
...
--------------------------------------------------------------------------------
    ...
    objtype varchar(16) NOT NULL,   --/D Why this object was targeted.  Note that if this field says QSO, it could be the case that this object would have been targeted as a GALAXY or any number of other categories as well. The PRIMTARGET and SECTARGET flags in the plug-map structure (in the spField file) gives this full information.  
    too varchar(35) NOT NULL,   --/D the fiber is allocated to a TOO  
    ...
    ra_list varchar(197) NOT NULL,    --/U degrees --/D List of measured RA per exposure  
    dec_list varchar(179) NOT NULL,    --/U degrees --/D List of measured DEC per exposure  
    delta_ra_list varchar(143) NOT NULL,    --/U arcsec --/D List of designed RA offsets per exposure  
    delta_dec_list varchar(143) NOT NULL,    --/U arcsec --/D List of designed DEC offsets per exposure  
    fiber_offset bigint NOT NULL,   --/D Flag identifying the fiber was offset by design  
    xfocal varchar(161) NOT NULL,    --/U mm --/D Hole/robot x-axis position in focal plane  
    yfocal varchar(161) NOT NULL,    --/U mm --/D Hole/robot y-axis position in focal plane  
    zoffset real NOT NULL,    --/U microns --/D Backstopping offset distance  
    ...
    moon_dist varchar(107) NOT NULL,    --/U degrees --/D Mean Moon-target separation of Coadded Spectra  
    moon_phase varchar(89) NOT NULL,   --/D Mean Moon phase of the Coadded Spectra  
    assigned varchar(64) NOT NULL,   --/D Whether this fibre was assigned to a target  
    on_target varchar(64) NOT NULL,   --/D Whether this fibre is on target  
    valid varchar(64) NOT NULL,   --/D alpha and beta angles are valid  
    decollided varchar(64) NOT NULL,   --/D this positioner had to be moved to decollide it  
    anyandmask bigint NOT NULL,   --/D For each bit, records whether any pixel in the spectrum has that bit set in its ANDMASK  
    anyormask bigint NOT NULL,   --/D For each bit, records whether any pixel in the spectrum has that bit set in its ORMASK  
    specprimary tinyint NOT NULL,   --/D Objects observed multiple times will have this set to 1 for one observation only. This is usually the 'best' observation, as defined by critera listed in fieldmerge.py.  
    specboss bigint NOT NULL,   --/D Best version of spectrum at this location  
    boss_specobj_id bigint NOT NULL,   --/D ID of spectrum location on sky  
    nspecobs bigint NOT NULL,   --/D Number of spectral observations  
    spectroflux_u real NOT NULL,    --/U nanomaggy --/D Spectrum projected onto SDSS-u filter  --/F SPECTROFLUX
    spectroflux_g real NOT NULL,    --/U nanomaggy --/D Spectrum projected onto SDSS-g filter  --/F SPECTROFLUX
    spectroflux_r real NOT NULL,    --/U nanomaggy --/D Spectrum projected onto SDSS-r filter  --/F SPECTROFLUX
    spectroflux_i real NOT NULL,    --/U nanomaggy --/D Spectrum projected onto SDSS-i filter  --/F SPECTROFLUX
    spectroflux_z real NOT NULL,    --/U nanomaggy --/D Spectrum projected onto SDSS-z filter  --/F SPECTROFLUX
    spectroflux_ivar_u real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROFLUX_u  --/F SPECTROFLUX_IVAR
    spectroflux_ivar_g real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROFLUX_g  --/F SPECTROFLUX_IVAR
    spectroflux_ivar_r real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROFLUX_r  --/F SPECTROFLUX_IVAR
    spectroflux_ivar_i real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROFLUX_i  --/F SPECTROFLUX_IVAR
    spectroflux_ivar_z real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROFLUX_z  --/F SPECTROFLUX_IVAR
    spectrosynflux_u real NOT NULL,    --/U nanomaggy --/D Best-fit template projected onto SDSS-u  --/F SPECTROSYNFLUX
    spectrosynflux_g real NOT NULL,    --/U nanomaggy --/D Best-fit template projected onto SDSS-g  --/F SPECTROSYNFLUX
    spectrosynflux_r real NOT NULL,    --/U nanomaggy --/D Best-fit template projected onto SDSS-r  --/F SPECTROSYNFLUX
    spectrosynflux_i real NOT NULL,    --/U nanomaggy --/D Best-fit template projected onto SDSS-i  --/F SPECTROSYNFLUX
    spectrosynflux_z real NOT NULL,    --/U nanomaggy --/D Best-fit template projected onto SDSS-z  --/F SPECTROSYNFLUX
    spectrosynflux_ivar_u real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROSYNFLUX_u  --/F SPECTROSYNFLUX_IVAR
    spectrosynflux_ivar_g real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROSYNFLUX_g  --/F SPECTROSYNFLUX_IVAR
    spectrosynflux_ivar_r real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROSYNFLUX_r  --/F SPECTROSYNFLUX_IVAR
    spectrosynflux_ivar_i real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROSYNFLUX_i  --/F SPECTROSYNFLUX_IVAR
    spectrosynflux_ivar_z real NOT NULL,    --/U nanomaggy --/D Inverse variance of SPECTROSYNFLUX_z  --/F SPECTROSYNFLUX_IVAR
    spectroskyflux_u real NOT NULL,    --/U nanomaggy --/D Sky spectrum projected onto SDSS-u filter  --/F SPECTROSKYFLUX
    spectroskyflux_g real NOT NULL,    --/U nanomaggy --/D Sky spectrum projected onto SDSS-g filter  --/F SPECTROSKYFLUX
    spectroskyflux_r real NOT NULL,    --/U nanomaggy --/D Sky spectrum projected onto SDSS-r filter  --/F SPECTROSKYFLUX
    spectroskyflux_i real NOT NULL,    --/U nanomaggy --/D Sky spectrum projected onto SDSS-i filter  --/F SPECTROSKYFLUX
    spectroskyflux_z real NOT NULL,    --/U nanomaggy --/D Sky spectrum projected onto SDSS-z filter  --/F SPECTROSKYFLUX
    wavemin real NOT NULL,    --/U AA --/D Minimum observed (vacuum) wavelength for target  
    wavemax real NOT NULL,    --/U AA --/D Maximum observed (vacuum) wavelength for target  
    wcoverage real NOT NULL,    --/U log10(AA) --/D Amount of wavelength coverage in log-10(Angs)  
    class varchar(6) NOT NULL,   --/D Spectro classification: GALAXY, QSO, STAR  
    ...
    vdispdof bigint NOT NULL,   --/D Degrees of freedom for best-fit velocity dispersion, equal to VDISPNPIX minus the number of templates minus the number of polynomial terms minus 1 (the last 1 is for the velocity dispersion)  
    chi68p real NOT NULL,   --/D 68% of abs(chi) of synthetic to actual spectrum  
    fracnsigma_1 real NOT NULL,   --/D Fraction of pixels deviant by >1 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_2 real NOT NULL,   --/D Fraction of pixels deviant by >2 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_3 real NOT NULL,   --/D Fraction of pixels deviant by >3 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_4 real NOT NULL,   --/D Fraction of pixels deviant by >4 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_5 real NOT NULL,   --/D Fraction of pixels deviant by >5 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_6 real NOT NULL,   --/D Fraction of pixels deviant by >6 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_7 real NOT NULL,   --/D Fraction of pixels deviant by >7 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_8 real NOT NULL,   --/D Fraction of pixels deviant by >8 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_9 real NOT NULL,   --/D Fraction of pixels deviant by >9 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    fracnsigma_10 real NOT NULL,   --/D Fraction of pixels deviant by >10 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGMA
    ...
    fracnsiglo_1 real NOT NULL,   --/D Fraction of pixels low by >1 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_2 real NOT NULL,   --/D Fraction of pixels low by >2 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_3 real NOT NULL,   --/D Fraction of pixels low by >3 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_4 real NOT NULL,   --/D Fraction of pixels low by >4 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_5 real NOT NULL,   --/D Fraction of pixels low by >5 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_6 real NOT NULL,   --/D Fraction of pixels low by >6 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_7 real NOT NULL,   --/D Fraction of pixels low by >7 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_8 real NOT NULL,   --/D Fraction of pixels low by >8 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_9 real NOT NULL,   --/D Fraction of pixels low by >9 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    fracnsiglo_10 real NOT NULL,   --/D Fraction of pixels low by >10 sigma (igorning all points blueward of rest-frame 1216 Ang)  --/F FRACNSIGLO
    z_noqso real NOT NULL,   --/D Redshift of the best-fit non-QSO model (recommended for CMASS and LOZ)  
    z_err_noqso real NOT NULL,   --/D Formal one-sigma error on Z_NOQSO (recommended for CMASS and LOZ)  
    znum_noqso bigint NOT NULL,   --/D Best fit z/class index excluding QSO; 1-indexed (recommended for CMASS and LOZ)  
    zwarning_noqso bigint NOT NULL,   --/D Redshift warning flag for Z_NOQSO (recommended for CMASS and LOZ)  
...
*/
-- DR20 version of spAll_allepoch
CREATE TABLE spAll_allepoch (
--------------------------------------------------------------------------------
--/H Summary spectroscopic information for the BOSS spectrograph data custom Coadds
--
...
--------------------------------------------------------------------------------
    ...
    firstcarton varchar(54) NOT NULL,   --/D Primary SDSS Carton for target  
    carton_to_target_pk varchar(32) NOT NULL,   --/D SDSS-V CartonToTarget DB Table Primary Key  
    objtype varchar(16) NOT NULL,   --/D Why this object was targetargetedtted.  Note that if this field says QSO, it could be the case that this object would have been targeted as a GALAXY or any number of other categories as well. The PRIMTARGET and SECTARGET flags in the plug-map structure (in the spField file) gives this full information.  
    too varchar(57) NOT NULL,   --/D the fiber is allocated to a TOO  
    too_id bigint NOT NULL,   --/D SDSS-V Target of Opportunity ID (only if TOO)  
    catalogid bigint NOT NULL,   --/D SDSS-V CatalogID used in naming  
    catalogid_v0 bigint NOT NULL,   --/D SDSS-V CatalogID from Catalog v0  
    catalogid_v0p5 bigint NOT NULL,   --/D SDSS-V CatalogID from Catalog v0.5  
    ...
    ra_list varchar(318) NOT NULL,    --/U degrees --/D List of measured RA per exposure  
    dec_list varchar(289) NOT NULL,    --/U degrees --/D List of measured DEC per exposure  
    delta_ra_list varchar(231) NOT NULL,    --/U arcsec --/D List of designed RA offsets per exposure  
    delta_dec_list varchar(231) NOT NULL,    --/U arcsec --/D List of designed DEC offsets per exposure  
    fiber_offset bigint NOT NULL,   --/D Flag identifying the fiber was offset by design  
    xfocal varchar(260) NOT NULL,    --/U mm --/D Hole/robot x-axis position in focal plane  
    yfocal varchar(260) NOT NULL,    --/U mm --/D Hole/robot y-axis position in focal plane  
    zoffset real NOT NULL,    --/U microns --/D Backstopping offset distance  
    ...
    moon_dist varchar(144) NOT NULL,    --/U degrees --/D Mean Moon-target separation of Coadded Spectra  
    moon_phase varchar(144) NOT NULL,   --/D Mean Moon phase of the Coadded Spectra  
    assigned varchar(144) NOT NULL,   --/D Whether this fibre was assigned to a target  
    on_target varchar(144) NOT NULL,   --/D Whether this fibre is on target  
    valid varchar(144) NOT NULL,   --/D alpha and beta angles are valid  
    decollided varchar(144) NOT NULL,   --/D this positioner had to be moved to decollide it  
    anyandmask bigint NOT NULL,   --/D For each bit, records whether any pixel in the spectrum has that bit set in its ANDMASK  
    anyormask bigint NOT NULL,   --/D For each bit, records whether any pixel in the spectrum has that bit set in its ORMASK  
    specprimary tinyint NOT NULL,   --/D Objects observed multiple times will have this set to 1 for one observation only. This is usually the 'best' observation, as defined by critera listed in fieldmerge.py.  
    specboss bigint NOT NULL,   --/D Best version of spectrum at this location  
