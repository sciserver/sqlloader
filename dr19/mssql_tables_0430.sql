...
----------------------------------------------------------------------
    ...
    apstar_id varchar(500) NOT NULL, --/U ns].[sc --/D Unique ASPCAP identifier: apogee.
    aspcap_id varchar(500), --/U ns].[sc].APSTAR_VERS.LOC.STAR, where [ns] is for APOGEE North/South, [sc --/D Unique apStar identifier: apogee.
    ...
    fparam varchar(500), --/U M/H], [C/M], [N/M], [alpha/M --/D Output parameter array from ASPCAP stellar parameters fit, in order given in PARAM_SYMBOL array in HDU3: Teff, logg, vmicro, 
    fparam_cov varchar(500), --/D Covariance of fitted parameters from FERRE
    aspcap_chi2 real, --/D Chi^2 from ASPCAP fit
    param varchar(500), --/U M/H], [C/M], [N/M], [alpha/M --/D Empirically calibrated parameter array, using ASPCAP stellar parameters fit + calibrations, in order given in PARAM_SYMBOL array in HDU3: Teff, logg, vmicro, 
    ...
    x_h varchar(500), --/U X/H --/D Empirically calibrated individual element array, using ASPCAP stellar abundances fit + calibrations, all expressed in logarithmic abundance relative to H (
    x_h_err varchar(500), --/U X/H --/D Empirical uncertainties in 
    x_m varchar(500), --/U X/M --/D Empirically calibrated individual element array, using ASPCAP stellar abundances fit + calibrations, all expressed in logarithmic abundance relative to M (
    x_m_err varchar(500), --/U X/M --/D Empirical uncertainties in 
...
--/T differ from [public]ly available eROSITA catalogs. The <br>
...
DROP TABLE IF EXISTS dbo.dr19_catalog_to_gaia_dr2_source
...
DROP TABLE IF EXISTS dbo.dr19_catalog_to_mangatarget
...
DROP TABLE IF EXISTS dbo.dr19_catalog_to_twomass_psc
...
--/T known at the time of target selection and may differ from [public]ly <br>
...
----------------------------------------------------------------------
--/H Well-defined and varcharized all-sky sample of
...
DROP TABLE IF EXISTS dbo.dr19_legacy_catalog_catalogid
...
DROP TABLE IF EXISTS dbo.dr19_sdss_dr17_specobj
...
DROP TABLE IF EXISTS dbo.dr19_sdss_id_to_catalog_full
...
DROP TABLE IF EXISTS dbo.dr19_target_union_legacy
...
--/T table. To associate a targeting_generation with a robostrategy planname, <br>
