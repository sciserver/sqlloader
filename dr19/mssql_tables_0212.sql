...
CREATE TABLE dbo.dr19_sdssv_boss_spall (
    ...
    spec1_r real,
    spec1_i real,
    elodie_filenamename varchar(500),
...
CREATE TABLE dbo.dr19_sdssv_plateholes (
    ...
    yfocal double precision,
    yanny_uid integer,
    yanny_filenamename varchar(500),
    pkey bigint NOT NULL
);
